    ...
    <div>
      ...
      <div className='container'>
        <div>
          ...
          />
          <button className='btn btn-warning' onClick={() => handleButtonClick(1)}>1hr</button>
          <button className='btn btn-danger' onClick={() => handleButtonClick(8)}>8hr</button>
          <button className='btn btn-info' onClick={() => handleButtonClick(24)}>24hr</button>
        </div>
        <hr />
        <div>
